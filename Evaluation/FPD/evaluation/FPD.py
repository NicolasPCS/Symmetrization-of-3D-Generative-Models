...
def calculate_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6):
    ...
    print("Means Distance:", diff.dot(diff)) # how far the means are (higger: distributions are not aligned)
    print("Dist. Similarity:", np.trace(sigma1) + np.trace(sigma2) - 2 * tr_covmean) # covariance difference (higher: distributions are not similar)
...
def calculate_fpd(pointclouds1, pointclouds2=None, batch_size=100, dims=1808, device=None):
    ...
    print("PC1.shape: ", pointclouds1.shape)
    print("PC2.shape: ", pointclouds2.shape if pointclouds2 is not None else "None")

    PointNet_path = '/home/ncaytuir/TreeGAN_necs/evaluation/cls_model_39.pth'
    statistic_save_path = '/home/ncaytuir/TreeGAN_necs/MyScripts/PVD/airplane/ckpt_6199/gt_pre_statistics.npz'
